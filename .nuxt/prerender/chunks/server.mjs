import proxy__default from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/unenv/runtime/mock/proxy.mjs';
import { s as serverRenderer, r as require$$1 } from './renderer.mjs';
import { $fetch as $fetch$1 } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/ohmyfetch/dist/node.mjs';
import { withBase, withLeadingSlash, withoutTrailingSlash, joinURL, hasProtocol, isEqual as isEqual$1, encodeParam, parseURL, encodePath } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/ufo/dist/index.mjs';
import { createHooks } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/unctx/dist/index.mjs';
import destr from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/destr/dist/index.mjs';
import { appendHeader, createError as createError$1, sendRedirect } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/h3/dist/index.mjs';
import defu, { defu as defu$1 } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/defu/dist/defu.mjs';
import { pascalCase } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/scule/dist/index.mjs';
import { find, html } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/property-information/index.js';
import htmlTags from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/html-tags/index.js';
import { hash, isEqual } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/ohash/dist/index.mjs';
import { parse, serialize } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/cookie-es/dist/index.mjs';
import moment from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/moment/moment.js';
import { loadFull } from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/tsparticles/cjs/index.js';
import Particles from 'file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/particles.vue3/dist/particles.vue3.umd.js';
...
(function(exports) {
  ...
  var compilerDom = proxy__default;
...
const components = {
  ContentDoc: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(() => ContentDoc).then((c) => c.default || c)),
  ContentList: vue_cjs_prod.defineAsyncComponent(() => import('./ContentList.e211ff38.mjs').then((c) => c.default || c)),
  ContentNavigation: vue_cjs_prod.defineAsyncComponent(() => import('./ContentNavigation.a96a780d.mjs').then((c) => c.default || c)),
  ContentQuery: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(() => ContentQuery$1).then((c) => c.default || c)),
  ContentRenderer: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(() => ContentRenderer$1).then((c) => c.default || c)),
  Markdown: vue_cjs_prod.defineAsyncComponent(() => import('./Markdown.ddff477e.mjs').then((c) => c.default || c)),
  MarkdownRenderer: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(() => MarkdownRenderer$1).then((c) => c.default || c)),
  ProseA: vue_cjs_prod.defineAsyncComponent(() => import('./ProseA.533d15a3.mjs').then((c) => c.default || c)),
  ProseBlockquote: vue_cjs_prod.defineAsyncComponent(() => import('./ProseBlockquote.14759823.mjs').then((c) => c.default || c)),
  ProseCode: vue_cjs_prod.defineAsyncComponent(() => import('./ProseCode.4780f509.mjs').then((c) => c.default || c)),
  ProseCodeInline: vue_cjs_prod.defineAsyncComponent(() => import('./ProseCodeInline.17c4c3a6.mjs').then((c) => c.default || c)),
  ProseEm: vue_cjs_prod.defineAsyncComponent(() => import('./ProseEm.35d2873a.mjs').then((c) => c.default || c)),
  ProseH1: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH1.4c4f2fc8.mjs').then((c) => c.default || c)),
  ProseH2: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH2.a21098fa.mjs').then((c) => c.default || c)),
  ProseH3: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH3.f8ead5a0.mjs').then((c) => c.default || c)),
  ProseH4: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH4.2aab3e24.mjs').then((c) => c.default || c)),
  ProseH5: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH5.f5f9b692.mjs').then((c) => c.default || c)),
  ProseH6: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH6.101e2680.mjs').then((c) => c.default || c)),
  ProseHr: vue_cjs_prod.defineAsyncComponent(() => import('./ProseHr.502f7363.mjs').then((c) => c.default || c)),
  ProseImg: vue_cjs_prod.defineAsyncComponent(() => import('./ProseImg.8b083046.mjs').then((c) => c.default || c)),
  ProseLi: vue_cjs_prod.defineAsyncComponent(() => import('./ProseLi.d45ac984.mjs').then((c) => c.default || c)),
  ProseOl: vue_cjs_prod.defineAsyncComponent(() => import('./ProseOl.85994620.mjs').then((c) => c.default || c)),
  ProseP: vue_cjs_prod.defineAsyncComponent(() => import('./ProseP.e208b3ac.mjs').then((c) => c.default || c)),
  ProseStrong: vue_cjs_prod.defineAsyncComponent(() => import('./ProseStrong.de90e4cc.mjs').then((c) => c.default || c)),
  ProseTable: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTable.64f8cb69.mjs').then((c) => c.default || c)),
  ProseTbody: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTbody.242bf579.mjs').then((c) => c.default || c)),
  ProseTd: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTd.f8e936af.mjs').then((c) => c.default || c)),
  ProseTh: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTh.0fbaf372.mjs').then((c) => c.default || c)),
  ProseThead: vue_cjs_prod.defineAsyncComponent(() => import('./ProseThead.20be3b79.mjs').then((c) => c.default || c)),
  ProseTr: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTr.6b1d2c48.mjs').then((c) => c.default || c)),
  ProseUl: vue_cjs_prod.defineAsyncComponent(() => import('./ProseUl.b99da7bc.mjs').then((c) => c.default || c))
};
...
const metaConfig = { "globalMeta": { "meta": [{ "http-equiv": "X-UA-Compatible", "content": "IE=edge" }, { "hid": "description", "name": "description", "content": "Hello, I'm Mishu!" }, { "hid": "robots", "name": "robots", "content": "index,follow" }, { "hid": "theme-color", "name": "theme-color", "content": "#5672fc" }, { "hid": "og:title", "name": "og:title", "property": "og:title", "content": "Mishu" }, { "hid": "og:description", "name": "og:description", "property": "og:description", "content": "Hello, I'm Mishu!" }, { "hid": "og:site_name", "name": "og:site_name", "property": "og:site_name", "content": "Mishu" }, { "hid": "og:image", "name": "og:image", "property": "og:image", "content": "https://cdn.discordapp.com/attachments/1077731148060438741/1089634110147932280/VcM7fMx.png" }, { "hid": "og:type", "name": "og:type", "property": "og:type", "content": "website" }, { "hid": "og:url", "name": "og:url", "property": "og:url", "content": "https://mishu.dev" }, { "hid": "twitter:title", "name": "twitter:title", "content": "Mishu" }, { "hid": "twitter:description", "name": "twitter:description", "content": "Hello, I'm Mishu!" }, { "hid": "twitter:site", "name": "twitter:site", "content": "Mishu" }, { "hid": "twitter:image", "name": "twitter:image", "content": "https://cdn.discordapp.com/attachments/1077731148060438741/1089634110147932280/VcM7fMx.png" }, { "hid": "twitter:card", "name": "twitter:card", "content": "summary" }], "link": [{ "rel": "stylesheet", "href": "https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.0/css/bootstrap.min.css" }, { "rel": "stylesheet", "href": "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.2/css/all.min.css" }, { "rel": "stylesheet", "href": "https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/devicon.min.css" }, { "rel": "icon", "type": "image/x-icon", "href": "https://cdn.discordapp.com/attachments/1077731148060438741/1089634110147932280/VcM7fMx.png" }, { "rel": "apple-touch-icon", "href": "https://cdn.discordapp.com/attachments/1077731148060438741/1089634110147932280/VcM7fMx.png" }, { "rel": "alternate", "type": "application/rss+xml", "title": "Mishu", "href": "https://mishu.dev/rss.xml" }], "style": [], "script": [{ "src": "https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.0/js/bootstrap.min.js" }], "noscript": [{ "children": "Javascript is required" }], "htmlAttrs": { "lang": "en" }, "title": "Mishu", "charset": "utf-8", "viewport": "width=device-width, initial-scale=1" } };
const metaMixin = {
  created() {
    const instance = vue_cjs_prod.getCurrentInstance();
    if (!instance) {
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    const props = __props;
    const { pages } = vue_cjs_prod.toRefs(props);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: "mt-3",
        "aria-label": "breadcrumb"
      }, _attrs))}><ol class="breadcrumb m-1"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(pages), (item, i) => {
        _push(`<li${serverRenderer.exports.ssrRenderAttr("aria-current", item.active ? "page" : null)} class="${serverRenderer.exports.ssrRenderClass([item.active ? "active" : null, "breadcrumb-item"])}">`);
        if (item.active) {
          _push(`<span>${serverRenderer.exports.ssrInterpolate(item.name)}</span>`);
        } else {
          _push(`<a${serverRenderer.exports.ssrRenderAttr("href", item.url)}>${serverRenderer.exports.ssrInterpolate(item.name)}</a>`);
        }
        _push(`</li>`);
      });
      _push(`<!--]--></ol></nav>`);
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file://C:/Users/adria/OneDrive/Documentos/Programaci%C3%B3n/Pagina%20web%20test/mishu.dev/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$5]]);
  ...
  render(ctx) {
    ...
    return vue_cjs_prod.h(ContentQuery, contentQueryProps, {
      default: (slots == null ? void 0 : slots.default) ? ({ data, refresh, isPartial }) => {
        ...
        addHead(data);
        return vue_cjs_prod.h(ContentRenderer, { value: data, excerpt, tag, ...this.$attrs }, { empty: (bindings) => (slots == null ? void 0 : slots.empty) ? slots.empty(bindings) : emptyNode("default", data) });
      },
      empty: (bindings) => {
        var _a;
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    const props = __props;
    const { links } = vue_cjs_prod.toRefs(props);
    return (_ctx, _push, _parent, _attrs) => {
      if (vue_cjs_prod.unref(links).length > 2) {
        _push(`<aside${serverRenderer.exports.ssrRenderAttrs(_attrs)}><h3 class="h5 font-bold toc-title">Table of contents</h3><ul><!--[-->`);
        serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(links), (item, i) => {
          _push(`<li class="toc-item"><a${serverRenderer.exports.ssrRenderAttr("href", `#${item.id}`)}>${serverRenderer.exports.ssrInterpolate(item.text)}</a>`);
          if (item.children && item.children.length > 0) {
            _push(`<ul><!--[-->`);
            serverRenderer.exports.ssrRenderList(item.children, (subitem, j) => {
              _push(`<span>`);
              if (subitem.text) {
                _push(`<li class="toc-item"><a${serverRenderer.exports.ssrRenderAttr("href", `#${subitem.id}`)}>${serverRenderer.exports.ssrInterpolate(subitem.text)}</a></li>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</span>`);
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<footer${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "text-center m-1" }, _attrs))}><span class="align">Copyright ${serverRenderer.exports.ssrInterpolate(new Date().getFullYear())} | Created using <i class="devicon-nuxtjs-plain colored"></i> by <a href="https://mishu.dev" target="_blank">Mishu</a>.</span>`);
  if (vue_cjs_prod.unref(useRoute)().path == "/") {
    _push(`<span class="add-label"><a href="https://www.freepik.com/vectors/cartoon-space" target="_blank">Cartoon space vector</a> created by mishu - <a href="https://freepik.com" target="_blank">freepik.com</a>.</span>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</footer>`);
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_Particles = vue_cjs_prod.resolveComponent("Particles");
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_client_only, null, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(serverRenderer.exports.ssrRenderComponent(_component_Particles, {
          class: "position-absolute h-100 w-100",
          id: "tsparticles",
          options: $data.options,
          "particles-init": $options.particlesInit
        }, null, _parent2, _scopeId));
      } else {
        return [
          vue_cjs_prod.createVNode(_component_Particles, {
            class: "position-absolute h-100 w-100",
            id: "tsparticles",
            options: $data.options,
            "particles-init": $options.particlesInit
          }, null, 8, ["options", "particles-init"])
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`<div class="center"><span class="regular">Hello, I&#39;m</span><h1 class="title">${$data.header}</h1><div class="icons socials row text-center mt-4"><!--[-->`);
  serverRenderer.exports.ssrRenderList($props.settings.socials, (item, i) => {
    _push(`<div class="col"><a${serverRenderer.exports.ssrRenderAttr("href", item.url)} target="_blank"><i style="${serverRenderer.exports.ssrRenderStyle(`color:${item.color}`)}" class="${serverRenderer.exports.ssrRenderClass(item.icon)}"></i></a></div>`);
  });
  _push(`<!--]--></div>`);
  if ($props.settings.favourites && $props.settings.favourites.length > 0) {
    _push(`<div class="icons favourite row text-center mt-4 px-2"><h2 class="m-3 regular">What do I use</h2><!--[-->`);
    serverRenderer.exports.ssrRenderList($props.settings.favourites, (item, i) => {
      _push(`<div class="col"><i class="${serverRenderer.exports.ssrRenderClass(`${item} colored`)}"></i></div>`);
    });
    _push(`<!--]--></div>`);
  } else {
    _push(`<!---->`);
...
const _sfc_main$4 = {
  ...
  created() {
    this.sortedArticles = this == null ? void 0 : this.$props.articles.filter((a) => a.visibility == 1).sort((a, b) => b.created - a.created);
  }
};
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_img = __nuxt_component_4;
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "px-1" }, _attrs))}><h2 class="regular m-3">Posts &lt;3</h2><!--[-->`);
  serverRenderer.exports.ssrRenderList($data.sortedArticles, (item, i) => {
    _push(`<div class="d-block mx-auto mb-5"><div class="article-item rounded"><a${serverRenderer.exports.ssrRenderAttr("href", item._path)}>`);
    ...
    _push(`</a><div class="card-body m-2"><div class="article-tags"><!--[-->`);
    serverRenderer.exports.ssrRenderList(item.tags, (tag, j) => {
      _push(`<span class="badge bg-custom float-start">${serverRenderer.exports.ssrInterpolate(tag)}</span>`);
    });
    _push(`<!--]--><span class="float-end">${serverRenderer.exports.ssrInterpolate($data.moment.unix(item.created, "YYYYMMDD").fromNow())}</span></div><br><h3 class="card-title h4"><a${serverRenderer.exports.ssrRenderAttr("href", item._path)}>${serverRenderer.exports.ssrInterpolate(item.title)}</a></h3><p class="card-text mt-1 my-0 article-desc">${serverRenderer.exports.ssrInterpolate(item.description)}</p></div></div><hr class="mt-5"></div>`);
  });
  _push(`<!--]--></section>`);
}
  ...
  methods: {
    startInterval() {
      const getStatus = async () => {
        var _a, _b;
        try {
          const user = await $fetch(this == null ? void 0 : this.$props.discord.info_url);
          if (!user.success)
            throw "Could not fetch Discord account information.";
          const status = (_a = await $fetch(this == null ? void 0 : this.$props.discord.widget_url)) == null ? void 0 : _a.members.find((u) => u.username == user.data.username);
          this.fetched = {
            username: user.data.username,
            discriminator: user.data.discriminator,
            avatar: user.data.avatar_url,
            status: status == null ? void 0 : status.status,
            activity: (_b = status == null ? void 0 : status.game) == null ? void 0 : _b.name
          };
        } catch (err) {
          console.error(err);
        }
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  var _a;
  const _component_nuxt_img = __nuxt_component_4;
  if ($props.discord && $data.fetched) {
    _push(`<section${serverRenderer.exports.ssrRenderAttrs(_attrs)}><span>Discord status</span><div class="mt-1"><div class="row text-left">`);
    _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_img, {
      format: "webp",
      loading: "lazy",
      src: (_a = $data.fetched) == null ? void 0 : _a.avatar,
      width: "auto",
      height: "auto",
      class: "avatar img-circle m-2 p-1 inline-block",
      alt: "Avatar",
      style: { "border-radius": "50%" }
    }, null, _parent));
    _push(`<div class="inline-block discord-info"><span class="discord-username">${serverRenderer.exports.ssrInterpolate($data.fetched.username)}</span><span>#${serverRenderer.exports.ssrInterpolate($data.fetched.discriminator)}</span>`);
    if ($data.fetched.status) {
      _push(`<span class="d-block"> I&#39;m currently <b class="text-success">ONLINE</b>. `);
      if ($data.fetched.activity) {
        _push(`<span class="d-block">Playing: <b class="text-colored">${serverRenderer.exports.ssrInterpolate($data.fetched.activity)}</b></span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</span>`);
    } else {
      _push(`<span class="d-block">I&#39;m currently <b class="text-danger">OFFLINE</b>.</span>`);
    }
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    const props = __props;
    const { quotes } = vue_cjs_prod.toRefs(props);
    const quote = Math.floor(Math.random() * props.quotes.length);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${serverRenderer.exports.ssrRenderAttrs(_attrs)}><span>Random quote</span><blockquote class="blockquote border-0 p-0 mt-1"><p class="font-italic lead"><i class="fa fa-quote-left mr-3 text-colored"></i> ${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(quotes)[vue_cjs_prod.unref(quote)].quote)} <i class="fa fa-quote-right mr-3 text-colored"></i></p><footer class="blockquote-footer float-end">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(quotes)[vue_cjs_prod.unref(quote)].author)}</footer></blockquote></section>`);
    };
  }
};
...
const routes = [
  {
    name: "blog-slug",
    path: "/blog/:slug(.*)*",
    file: "C:/Users/adria/OneDrive/Documentos/Programaci\xF3n/Pagina web test/mishu.dev/pages/blog/[...slug].vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./_...slug_.b82a4b02.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "C:/Users/adria/OneDrive/Documentos/Programaci\xF3n/Pagina web test/mishu.dev/pages/index.vue",
    children: [],
    meta,
    alias: [],
    component: () => import('./index.a472ab7e.mjs').then((m) => m.default || m)
  }
];
...
const ipxRuntime$TMSQmDrNut = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  validateDomains,
  supportsAlias
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$TMSQmDrNut, defaults: {} }
};
...
const plugins_particles_vue3_ts_fvVTdV0lAp = defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(Particles);
});
const plugins_scrollToTop_ts_qhSEFOqbwG = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  plugins_particles_vue3_ts_fvVTdV0lAp,
  plugins_scrollToTop_ts_qhSEFOqbwG
];
const _sfc_main$1 = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./error-component.5461b692.mjs'));
    const nuxtApp = useNuxtApp();
...
export { ContentQuery as C, _export_sfc as _, useCookie as a, useAsyncData as b, useUnwrap as c, __nuxt_component_0$3 as d, entry$1 as default, useRuntimeConfig as e, useRoute as f, _sfc_main$9 as g, __nuxt_component_4 as h, __nuxt_component_2$1 as i, jsonStringify as j, _sfc_main$7 as k, __nuxt_component_5 as l, __nuxt_component_0$1 as m, __nuxt_component_1 as n, __nuxt_component_2 as o, _sfc_main$2 as p, queryContent as q, useHead as u, vue_cjs_prod as v, withContentBase as w };
