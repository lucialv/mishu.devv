...
import { joinURL, hasProtocol, withLeadingSlash, parseURL, withBase, withoutTrailingSlash, isEqual as isEqual$1, encodeParam, encodePath } from "ufo";
...
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrRenderStyle, ssrRenderSuspense } from "@vue/server-renderer";
...
const components = {
  ...
  ContentList: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ContentList.e211ff38.js").then((c) => c.default || c)),
  ContentNavigation: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ContentNavigation.a96a780d.js").then((c) => c.default || c)),
  ...
  Markdown: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/Markdown.ddff477e.js").then((c) => c.default || c)),
  MarkdownRenderer: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(() => MarkdownRenderer$1).then((c) => c.default || c)),
  ProseA: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseA.533d15a3.js").then((c) => c.default || c)),
  ProseBlockquote: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseBlockquote.14759823.js").then((c) => c.default || c)),
  ProseCode: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseCode.4780f509.js").then((c) => c.default || c)),
  ProseCodeInline: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseCodeInline.17c4c3a6.js").then((c) => c.default || c)),
  ProseEm: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseEm.35d2873a.js").then((c) => c.default || c)),
  ProseH1: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseH1.4c4f2fc8.js").then((c) => c.default || c)),
  ProseH2: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseH2.a21098fa.js").then((c) => c.default || c)),
  ProseH3: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseH3.f8ead5a0.js").then((c) => c.default || c)),
  ProseH4: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseH4.2aab3e24.js").then((c) => c.default || c)),
  ProseH5: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseH5.f5f9b692.js").then((c) => c.default || c)),
  ProseH6: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseH6.101e2680.js").then((c) => c.default || c)),
  ProseHr: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseHr.502f7363.js").then((c) => c.default || c)),
  ProseImg: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseImg.8b083046.js").then((c) => c.default || c)),
  ProseLi: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseLi.d45ac984.js").then((c) => c.default || c)),
  ProseOl: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseOl.85994620.js").then((c) => c.default || c)),
  ProseP: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseP.e208b3ac.js").then((c) => c.default || c)),
  ProseStrong: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseStrong.de90e4cc.js").then((c) => c.default || c)),
  ProseTable: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseTable.64f8cb69.js").then((c) => c.default || c)),
  ProseTbody: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseTbody.242bf579.js").then((c) => c.default || c)),
  ProseTd: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseTd.f8e936af.js").then((c) => c.default || c)),
  ProseTh: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseTh.0fbaf372.js").then((c) => c.default || c)),
  ProseThead: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseThead.20be3b79.js").then((c) => c.default || c)),
  ProseTr: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseTr.6b1d2c48.js").then((c) => c.default || c)),
  ProseUl: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/ProseUl.b99da7bc.js").then((c) => c.default || c))
};
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: "mt-3",
        "aria-label": "breadcrumb"
      }, _attrs))}><ol class="breadcrumb m-1"><!--[-->`);
      ssrRenderList(vue_cjs_prod.unref(pages), (item, i) => {
        _push(`<li${ssrRenderAttr("aria-current", item.active ? "page" : null)} class="${ssrRenderClass([item.active ? "active" : null, "breadcrumb-item"])}">`);
        if (item.active) {
          _push(`<span>${ssrInterpolate(item.name)}</span>`);
        } else {
          _push(`<a${ssrRenderAttr("href", item.url)}>${ssrInterpolate(item.name)}</a>`);
        }
        _push(`</li>`);
      });
      _push(`<!--]--></ol></nav>`);
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<img${ssrRenderAttrs(vue_cjs_prod.mergeProps({ key: _ctx.nSrc }, _ctx.nAttrs, {
    ref: "img",
    src: _ctx.nSrc
  }, _attrs))}>`);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (vue_cjs_prod.unref(links).length > 2) {
        _push(`<aside${ssrRenderAttrs(_attrs)}><h3 class="h5 font-bold toc-title">Table of contents</h3><ul><!--[-->`);
        ssrRenderList(vue_cjs_prod.unref(links), (item, i) => {
          _push(`<li class="toc-item"><a${ssrRenderAttr("href", `#${item.id}`)}>${ssrInterpolate(item.text)}</a>`);
          if (item.children && item.children.length > 0) {
            _push(`<ul><!--[-->`);
            ssrRenderList(item.children, (subitem, j) => {
              _push(`<span>`);
              if (subitem.text) {
                _push(`<li class="toc-item"><a${ssrRenderAttr("href", `#${subitem.id}`)}>${ssrInterpolate(subitem.text)}</a></li>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</span>`);
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "text-center m-1" }, _attrs))}><span class="align">Copyright ${ssrInterpolate(new Date().getFullYear())} | Created using <i class="devicon-nuxtjs-plain colored"></i> by <a href="https://mishu.dev" target="_blank">Mishu</a>.</span>`);
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_client_only, null, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Particles, {
  ...
  ssrRenderList($props.settings.socials, (item, i) => {
    _push(`<div class="col"><a${ssrRenderAttr("href", item.url)} target="_blank"><i style="${ssrRenderStyle(`color:${item.color}`)}" class="${ssrRenderClass(item.icon)}"></i></a></div>`);
  });
  _push(`<!--]--></div>`);
  if ($props.settings.favourites && $props.settings.favourites.length > 0) {
    ...
    ssrRenderList($props.settings.favourites, (item, i) => {
      _push(`<div class="col"><i class="${ssrRenderClass(`${item} colored`)}"></i></div>`);
    });
    _push(`<!--]--></div>`);
  } else {
    _push(`<!---->`);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "px-1" }, _attrs))}><h2 class="regular m-3">Posts &lt;3</h2><!--[-->`);
  ssrRenderList($data.sortedArticles, (item, i) => {
    _push(`<div class="d-block mx-auto mb-5"><div class="article-item rounded"><a${ssrRenderAttr("href", item._path)}>`);
    ...
    ssrRenderList(item.tags, (tag, j) => {
      _push(`<span class="badge bg-custom float-start">${ssrInterpolate(tag)}</span>`);
    });
    _push(`<!--]--><span class="float-end">${ssrInterpolate($data.moment.unix(item.created, "YYYYMMDD").fromNow())}</span></div><br><h3 class="card-title h4"><a${ssrRenderAttr("href", item._path)}>${ssrInterpolate(item.title)}</a></h3><p class="card-text mt-1 my-0 article-desc">${ssrInterpolate(item.description)}</p></div></div><hr class="mt-5"></div>`);
  });
  _push(`<!--]--></section>`);
}
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($props.discord && $data.fetched) {
    _push(`<section${ssrRenderAttrs(_attrs)}><span>Discord status</span><div class="mt-1"><div class="row text-left">`);
    _push(ssrRenderComponent(_component_nuxt_img, {
      format: "webp",
      loading: "lazy",
    ...
    _push(`<div class="inline-block discord-info"><span class="discord-username">${ssrInterpolate($data.fetched.username)}</span><span>#${ssrInterpolate($data.fetched.discriminator)}</span>`);
    if ($data.fetched.status) {
      _push(`<span class="d-block"> I&#39;m currently <b class="text-success">ONLINE</b>. `);
      if ($data.fetched.activity) {
        _push(`<span class="d-block">Playing: <b class="text-colored">${ssrInterpolate($data.fetched.activity)}</b></span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</span>`);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)}><span>Random quote</span><blockquote class="blockquote border-0 p-0 mt-1"><p class="font-italic lead"><i class="fa fa-quote-left mr-3 text-colored"></i> ${ssrInterpolate(vue_cjs_prod.unref(quotes)[vue_cjs_prod.unref(quote)].quote)} <i class="fa fa-quote-right mr-3 text-colored"></i></p><footer class="blockquote-footer float-end">${ssrInterpolate(vue_cjs_prod.unref(quotes)[vue_cjs_prod.unref(quote)].author)}</footer></blockquote></section>`);
    };
  }
};
...
const routes = [
  {
    ...
    component: () => import("./_nuxt/_...slug_.b82a4b02.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.a472ab7e.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/error-component.5461b692.js"));
    const nuxtApp = useNuxtApp();
...
export {
  ...
  useAsyncData as b,
  useUnwrap as c,
  __nuxt_component_0$3 as d,
  entry$1 as default,
  useRuntimeConfig as e,
  useRoute as f,
  _sfc_main$9 as g,
  __nuxt_component_4 as h,
  __nuxt_component_2$1 as i,
  jsonStringify as j,
  _sfc_main$7 as k,
  __nuxt_component_5 as l,
  __nuxt_component_0$1 as m,
  __nuxt_component_1 as n,
  __nuxt_component_2 as o,
  _sfc_main$2 as p,
  queryContent as q,
  useHead as u,
  vue_cjs_prod as v,
